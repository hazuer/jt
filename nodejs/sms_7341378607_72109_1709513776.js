const adb = require("adbkit");
		...
		const phoneNumber = `7341378607`;
		const message = `Te RECUERDO que tu paquete con JT - Tlaquiltenango está listo para ser recogido. Podrás hacerlo en los siguientes días y horarios: 04 DE MARZO y 05 DE MARZO, de 10:00 a.m. a 3:00 p.m. Si no puedes hacerlo dentro de este plazo, tu paquete será devuelto el 06 DE MARZO de 2024 a las 11:00 a.m.
